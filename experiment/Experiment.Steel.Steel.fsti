...
val steel_c (#a : Type) (#pre : pre_t) (#post : post_t a) (#req : req_t pre) (#ens : ens_t pre a post)
            (f : steel a pre post req ens KSteel)
  : unit_steel a pre post req ens
...
unfold inline_for_extraction
let steel_fe #a #pre #post #req #ens ($f : unit_steel a pre post req ens)
  : steel a pre post req ens KSteel
  = FSteel f
...
inline_for_extraction
val atomic_c (#opened : Mem.inames)
             (#a : Type) (#pre : pre_t) (#post : post_t a) (#req : req_t pre) (#ens : ens_t pre a post)
             (f : steel a pre post req ens (KAtomic opened))
  : unit_steel_atomic a opened pre post req ens
...
unfold inline_for_extraction
let atomic_fe #opened #a #pre #post #req #ens ($f : unit_steel_atomic a opened pre post req ens)
  : steel a pre post req ens (KAtomic opened)
  = FAtomic opened f
...
inline_for_extraction
val ghost_c (#opened : Mem.inames)
             (#a : Type) (#pre : pre_t) (#post : post_t a) (#req : req_t pre) (#ens : ens_t pre a post)
             (f : steel a pre post req ens (KGhost opened))
  : unit_steel_ghost a opened pre post req ens
...
unfold inline_for_extraction
let ghost_fe #opened #a #pre #post #req #ens ($f : unit_steel_ghost a opened pre post req ens)
  : steel a pre post req ens (KGhost opened)
  = FGhost opened f
...
inline_for_extraction
val ghostI_c (#opened : Mem.inames)
             (#a : Type) (#pre : pre_t) (#post : post_t a) (#req : req_t pre) (#ens : ens_t pre a post)
             (f : steel a pre post req ens (KGhostI opened))
  : unit_steel_ghostI a opened pre post req ens
...
unfold inline_for_extraction
let ghostI_fe #opened #a #pre #post #req #ens ($f : unit_steel_ghostI a opened pre post req ens)
  : steel a pre post req ens (KGhostI opened)
  = FGhostI opened f
